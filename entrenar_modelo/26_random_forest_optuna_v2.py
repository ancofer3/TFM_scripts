...
plt.scatter(y_test_nuevos, predicciones_nuevos, alpha=0.5)
plt.plot([y_test_nuevos.min(), y_test_nuevos.max()], [y_test_nuevos.min(), y_test_nuevos.max()], 'r--')
plt.xlabel("Real %ISM (RIN 9.9)")
plt.ylabel("Prediction %ISM")
plt.title("Modelo performance: Prediction vs Reality - New transcripts")
plt.savefig("prediccion_vs_real_nuevos.png")

plt.scatter(y_test_vistos, predicciones_vistos, alpha=0.5)
plt.plot([y_test_vistos.min(), y_test_vistos.max()], [y_test_vistos.min(), y_test_vistos.max()], 'r--')
plt.xlabel("Real %ISM (RIN 9.9)")
plt.ylabel("Prediction %ISM")
plt.title("Modelo performance: Prediction vs Reality - Known transcripts")
plt.savefig("prediccion_vs_real_vistos.png")
